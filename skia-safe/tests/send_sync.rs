...
mod effects {
    ...
    assert_impl_all!(gradient::interpolation::InPremul: Send, Sync);
    assert_impl_all!(gradient::interpolation::ColorSpace: Send, Sync);
...
mod gpu {
    ...
    mod ganesh {
        ...
        assert_impl_all!(gpu::FlushResult: Send, Sync);
