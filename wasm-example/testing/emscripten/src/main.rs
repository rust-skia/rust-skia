use skia_safe::{surfaces, AlphaType, Color, ColorType, ImageInfo, Paint, PaintStyle, Surface};
...
#[unsafe(no_mangle)]
pub extern "C" fn test_surface_alloc(width: i32, height: i32, count: u32) -> i32 {
    test_surface_alloc_impl(width, height, count)
}

#[unsafe(no_mangle)]
pub extern "C" fn test_surface_alloc_sequential(width: i32, height: i32, count: u32) -> i32 {
    test_surface_alloc_sequential_impl(width, height, count)
}

#[unsafe(no_mangle)]
pub extern "C" fn test_plain_rust_alloc(bytes: u32, rounds: u32) -> i32 {
